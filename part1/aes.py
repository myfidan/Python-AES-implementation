...
print('Plaintext = {}'.format(hex(plaintext)))
print('Key = {}'.format(hex(key)))

encryption_data = encryption(plaintext,key)
print('Encrypted message = {}'.format(hex(encryption_data)))

decryption_data = decryption(encryption_data,key)
print('Decrypted message = {}'.format(hex(decryption_data)))